...
/* lk 32 custom instructions */
#define MATCH_CUSTOM0 0x200002b
#define MASK_CUSTOM0  0xfe00707f
#define MATCH_CUSTOM1 0x200102b
#define MASK_CUSTOM1 0xfe00707f
#define MATCH_CUSTOM2 0x200202b
#define MASK_CUSTOM2 0xfe00707f
#define MATCH_CUSTOM3 0x200302b
#define MASK_CUSTOM3 0xfe00707f
#define MATCH_CUSTOM4 0x200402b
#define MASK_CUSTOM4 0xfe00707f
#define MATCH_CUSTOM5 0x200502b
#define MASK_CUSTOM5 0xfe00707f
#define MATCH_CUSTOM6 0x200602b
#define MASK_CUSTOM6 0xfe00707f
#define MATCH_CUSTOM7 0x200702b
#define MASK_CUSTOM7 0xfe00707f
#define MATCH_CUSTOM8 0x600002b
#define MASK_CUSTOM8 0xfe00707f
#define MATCH_CUSTOM9 0x600102b
#define MASK_CUSTOM9 0xfe00707f
#define MATCH_CUSTOM10 0x600202b
#define MASK_CUSTOM10 0xfe00707f
// #define MATCH_CUSTOM11 0x600302b  
// #define MASK_CUSTOM11 0xfe00707f  likai
#define MATCH_CUSTOM11 0x600302b
#define MASK_CUSTOM11 0x600707f

#define MATCH_CUSTOM12 0x600402b
#define MASK_CUSTOM12 0xfe00707f
#define MATCH_CUSTOM13 0x600502b
#define MASK_CUSTOM13 0xfe00707f
#define MATCH_CUSTOM14 0x600602b
#define MASK_CUSTOM14 0xfe00707f
#define MATCH_CUSTOM15 0x600702b
#define MASK_CUSTOM15 0xfe00707f

#define MATCH_CUSTOM16 0x5b
#define MASK_CUSTOM16 0x600707f
#define MATCH_CUSTOM17 0x105b
#define MASK_CUSTOM17 0x600707f
#define MATCH_CUSTOM18 0x205b
#define MASK_CUSTOM18 0x600707f
#define MATCH_CUSTOM19 0x305b
#define MASK_CUSTOM19 0x600707f
#define MATCH_CUSTOM20 0x405b
#define MASK_CUSTOM20 0x600707f
#define MATCH_CUSTOM21 0x505b
#define MASK_CUSTOM21 0x600707f
#define MATCH_CUSTOM22 0x605b
#define MASK_CUSTOM22 0x600707f
#define MATCH_CUSTOM23 0x705b
#define MASK_CUSTOM23 0x600707f
#define MATCH_CUSTOM24 0x400005b
#define MASK_CUSTOM24 0x600707f
#define MATCH_CUSTOM25 0x400105b
#define MASK_CUSTOM25 0x600707f
#define MATCH_CUSTOM26 0x400205b
#define MASK_CUSTOM26 0x600707f
#define MATCH_CUSTOM27 0x400305b
#define MASK_CUSTOM27 0x600707f
#define MATCH_CUSTOM28 0x400405b
#define MASK_CUSTOM28 0x600707f
#define MATCH_CUSTOM29 0x400505b
#define MASK_CUSTOM29 0x600707f
#define MATCH_CUSTOM30 0x400605b
#define MASK_CUSTOM30 0x600707f
#define MATCH_CUSTOM31 0x400705b
#define MASK_CUSTOM31 0x600707f
/* lk 32 custom instructions */
...
DECLARE_INSN(custom4, MATCH_CUSTOM4, MASK_CUSTOM4)
DECLARE_INSN(custom5, MATCH_CUSTOM5, MASK_CUSTOM5)
DECLARE_INSN(custom6, MATCH_CUSTOM6, MASK_CUSTOM6)
DECLARE_INSN(custom7, MATCH_CUSTOM7, MASK_CUSTOM7)
DECLARE_INSN(custom8, MATCH_CUSTOM8, MASK_CUSTOM8)
DECLARE_INSN(custom9, MATCH_CUSTOM9, MASK_CUSTOM9)
DECLARE_INSN(custom10, MATCH_CUSTOM10, MASK_CUSTOM10)
DECLARE_INSN(custom11, MATCH_CUSTOM11, MASK_CUSTOM11)
DECLARE_INSN(custom12, MATCH_CUSTOM12, MASK_CUSTOM12)
DECLARE_INSN(custom13, MATCH_CUSTOM13, MASK_CUSTOM13)
DECLARE_INSN(custom14, MATCH_CUSTOM14, MASK_CUSTOM14)
DECLARE_INSN(custom15, MATCH_CUSTOM15, MASK_CUSTOM15)

DECLARE_INSN(custom16, MATCH_CUSTOM16, MASK_CUSTOM16)
DECLARE_INSN(custom17, MATCH_CUSTOM17, MASK_CUSTOM17)
DECLARE_INSN(custom18, MATCH_CUSTOM18, MASK_CUSTOM18)
DECLARE_INSN(custom19, MATCH_CUSTOM19, MASK_CUSTOM19)
DECLARE_INSN(custom20, MATCH_CUSTOM20, MASK_CUSTOM20)
DECLARE_INSN(custom21, MATCH_CUSTOM21, MASK_CUSTOM21)
DECLARE_INSN(custom22, MATCH_CUSTOM22, MASK_CUSTOM22)
DECLARE_INSN(custom23, MATCH_CUSTOM23, MASK_CUSTOM23)
DECLARE_INSN(custom24, MATCH_CUSTOM24, MASK_CUSTOM24)
DECLARE_INSN(custom25, MATCH_CUSTOM25, MASK_CUSTOM25)
DECLARE_INSN(custom26, MATCH_CUSTOM26, MASK_CUSTOM26)
DECLARE_INSN(custom27, MATCH_CUSTOM27, MASK_CUSTOM27)
DECLARE_INSN(custom28, MATCH_CUSTOM28, MASK_CUSTOM28)
DECLARE_INSN(custom29, MATCH_CUSTOM29, MASK_CUSTOM29)
DECLARE_INSN(custom30, MATCH_CUSTOM30, MASK_CUSTOM30)
DECLARE_INSN(custom31, MATCH_CUSTOM31, MASK_CUSTOM31)
/* lk 32 custom instructions */
